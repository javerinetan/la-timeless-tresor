...
var mExp=document.getElementById("month");
var yExp=document.getElementById("year");
var creditCard=document.getElementById("ccnum");
...
function validateform(){
    ...
    // if (!expMonth.test(mExp.value)){
    //   counter++;
    // }
    //
    // var expYear= .{2};//^\d{2}$;
    // if (!expYear.test(yExp.value)){
    //   counter++;
    // }
    // var regex = new RegExp("^[0-9]{16,16}$");
    // // var cardnumber=.{16} //\b\d{16}\b;
    // if (regex.test(creditCard.value)){
    //   counter++;
    // }
    //
    // var ccvNumber=.{3,3} //\b\d{3}\b;
    // if (ccvNumber.test(ccv.value)){
    //   counter++;
    // }
